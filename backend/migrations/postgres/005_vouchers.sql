...
CREATE TABLE IF NOT EXISTS voucher_rules (
  ...
  register_amount NUMERIC(12,2) NOT NULL DEFAULT 0,
  turnover_5000_amount NUMERIC(12,2) NOT NULL DEFAULT 0,
  turnover_10000_amount NUMERIC(12,2) NOT NULL DEFAULT 0,
